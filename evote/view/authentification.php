    ...
    <section id="contact" class="contact">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gx-lg-0 gy-4">
          ...
          <div class="col-lg-4">
            <form action="../controller/authentification.php" method="post" role="form" class="php-email-form">
              <div class="row">
              ...
              <?php 
                if(isset($_SESSION['erreurAuthEtudiant'])){
              ?>
              <div class="alert alert-danger" style="margin-top: 10px" role="alert">
              <?php echo $_SESSION['erreurAuthEtudiant']; ?>
              </div>
            <?php }?>
            </form>
