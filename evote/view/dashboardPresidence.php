...
$trouver = $candidature->getAllCandidaturePresidance();
...
?>
      <div class="main-panel">
        <div class="content-wrapper">
                    ...
                    foreach($trouver as $candidatures){?>
                        ...
                        <td class="py-1"> <img src=<?php echo $candidatures['photo']?> alt="image"/> </td>
                            ...
                            <button type="button" class="btn btn-success btn-sm btn-icon-text mr-3">
                                    <a href="../controller/validerCandidatPresidance.php?idCandidature=<?php echo $candidatures['idcandidature'];?>"> Valider <i class="typcn typcn-edit btn-icon-append"></i> </a>
                                </button>
                                <button type="button" class="btn btn-danger btn-sm btn-icon-text">
                                    <a href="../controller/supprimerCandidatPresidance.php?idCandidature=<?php echo $candidatures['idcandidature']; ?>"> Supprimer <i class="typcn typcn-delete-outline btn-icon-append"></i> </a>
                                </button>
                                </div>
                            </td>
                        </tr>
         ...
         <?php
         if(isset($_SESSION['notifDashboardPresidence']))
             echo $_SESSION['notifDashboardPresidence'];
       ?>
                </div>
              </div>
            </div>
