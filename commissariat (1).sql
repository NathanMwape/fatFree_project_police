...
--
-- Hôte : 127.0.0.1
-- Généré le : sam. 08 avr. 2023 à 20:14
...
(3, 'Mitraillette', 27, 'images/mitraillette.jpg'),
...
(95, 7, 3, 300, '2023-04-01', 'Mitraillette');
...
--
ALTER TABLE `rapports`
  ADD CONSTRAINT `rapport_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `users` (`id_user`),
  ADD CONSTRAINT `rapport_ibfk_2` FOREIGN KEY (`id_admin`) REFERENCES `admin` (`id_admin`);
COMMIT;
