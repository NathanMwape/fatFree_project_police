...
<head>
    ...
    <script> tinymce.init({ selector: '#pclu-textarea', valid_elements: '', branding: false });</script>
...
<body class="sb-nav-fixed">
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                    ...
                    <li><a class="dropdown-item" href="<?= ($BASE . '/admin/deconnection') ?>">
                            <i class="fa fa-power-off btn-danger fa-1x" style="background-color: red"
                                aria-hidden="true"></i>
    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content" class="shadow rounded-3"> 
            <main class="shadow rounded-3">
                <div class="container-fluid px-4">
                    <h1 class="mt-4"
                        style="font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;">RAPPORT
                    </h1>
                    <div class="card mb-4">


                        <div class="flex justify-content-between" style="margin: 10px;">
                            ...
                            <!-- choisir un commissariat ou l'on veut envoyer le rapport à l'aide d'un select -->
                            
                            <select name="commissariat" id="commissariat" class="form-select"
                                style="width: 200px; margin: 10px;">
                                <option value="0">--Choisir un commissariat--</option>
                                <?php foreach (($commissariat?:[]) as $com): ?>
                                    <option value="<?= ($com['id']) ?>"><?= ($com['nom_commissariat']) ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        <div id="rapport-form">
                                    ...
                                    <table class="table table-bordered" id="myTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <?php foreach (($rapports?:[]) as $rp): ?>
                                                <tr>
                                                    <td><?= (substr($rp['descriptions'], 0,11)) ?> [...]</td>
                                                    <td>
                                                        <a href="<?= (" ../../" . $rp['filename']) ?>" style="text-decoration: none;"><?= (substr($rp['filename'],
                                                            17)) ?>      <i class="fa fa-download" aria-hidden="true"></i> </a>
                                                    </td>
