            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo">Ajouter Arme</button>
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal2" data-bs-whatever="@fat">Ajouter Munition</button>
                            ...
                            <div class="modal-body">
                                <form method="POST" action="/arme_add" enctype="multipart/form-data">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="type_arme" class="form-control" id="recipient-name" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="message-text" class="col-form-label">Nombres</label>
                                        <input type="number" name="nombre_arme" class="form-control" id="recipient-name" required>
                                    </div>
                                    <div class="mb-3">
                        ...
                        <!-- Modal Munition -->
                            ...
                            <div class="modal fade" id="exampleModal2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" style="padding-left: 50px;">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                <div class="modal-header">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select id="arme" name="type_arme" class="form-control">
                                                <?php foreach (($arme?:[]) as $armes): ?> 
                                                    ...
                                                    <option id="<?= ($armes['id_arme']) ?>" value="<?= ($armes['type_arme']) ?>"><?= ($armes['type_arme']) ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                        <input type="hidden" id="id_arme" name="type_munition">
                                        <div class="mb-3">
                                            <label for="message-text" class="col-form-label">Nombre</label>
                                            <input type="text" name="nombre_munition" class="form-control" id="recipient-name">
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Fermer</button>
                                            <button type="submit" class="btn btn-primary">Enregistre</button>
                        ...
                        <!--  BODY OF Storage Weapon and  munition-->
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="card-body">
                                        <button class="btn btn-primary" id="btn-munitions">Afficher les munitions</button>
