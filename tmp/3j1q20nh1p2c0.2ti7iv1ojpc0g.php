                            ...
                            <div class="row row-cols-1 row-cols-md-3 g-7">
                                ...
                                <div class="col">
                                    <div class="card text-white bg-primary mb-3" >
                                        ...
                                        <div class="card-body">
                                            <h5 class="card-title"> Nous avons actuellement <?= ($countArme) ?>  armes enregistrées dans notre registre</h5>
                                ...
                                <div class="col">
                                    <div class="card text-white bg-success mb-3" >
                                        ...
                                        <div class="card-body">
                                            <h5 class="card-title"> Nous avons actuellement  <?= ($countMunition) ?> munitions enregistrées dans notre base de données.</h5>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <select class="form-select form-select-sm" id="nom_commissariat" aria-label=".form-select-sm example">
                                    <option selected disabled>Choisisez le Commissariat </option>
                                    <?php foreach (($unite_appart?:[]) as $police): ?>
                                        <option value="<?= ($police['unite_appartenance']) ?>"><?= ($police['unite_appartenance']) ?></option>	
                                    <?php endforeach; ?>
                                </select>
                                <table class="table">
                                    <thead>
