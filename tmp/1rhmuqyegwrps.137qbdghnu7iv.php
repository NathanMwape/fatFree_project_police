                    ...
                    <div class="modal-body">
                        <form action="/police/police_maj_dbb/<?= ($police['id_policier']) ?>" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    <input type="text" name="post_nom" value="<?= ($police['post_nom']) ?>"
                                        class="form-control">
                                </div><br><br>
                                ...
                                <div class="form-group col-md-6">
                                    <input type="date" name="date_naissance" value="<?= ($police['date_naissance']) ?>"
                                        class="form-control">
                                </div><br><br>
                                <div class="form-group col-md-6">
                                    <input type="text" name="pays_origine" value="<?= ($police['lieu_naissance']) ?>"
                                        class="form-control" placeholder="Votre pays">
                                </div><br><br>
                                <div class="form-group col-md-6">
                                    <input type="text" name="lieu_naissance" value="<?= ($police['lieu_naissance']) ?>"
                                ...
                                <div class="form-group col-md-6">
                                    <input type="text" name="matricule" value="<?= ($police['matricule']) ?>"
                                ...
                                <div class="form-group col-md-6">
                                    <input type="text" name="num_dossier" value="<?= ($police['num_dossier']) ?>"
                                        class="form-control" placeholder="numero de dossier">
                                </div>
                                <div class="form-group col-md-6">
                                    <input type="text" name="num_region" value="<?= ($police['num_region']) ?>"
                                        class="form-control" placeholder="numero de region">
                                </div><br><br>
                                <div class="form-group col-md-12">
                                    <input type="text" name="unite_appartenance" value="<?= ($police['unite_appartenance']) ?>"
                                        class="form-control" placeholder="unite d'appartenace">
                                </div><br><br>
                                <div class="form-group col-md-12">
                                    <select name="nom_commissariat" value="<?= ($police['nom_commissariat']) ?>"
                                        class="form-control">
                                        <option value="" selected disabled>nom comissariat</option>
                                        <option value="CIAT katuba">CIAT katuba</option>
                                        <option value="CIAT Kapemba">CIAT kapemba</option>
                                        <option value="CIAT Rwashi">CIAT Rwashi</option>
                                        <option value="CIAT plateau karavia">CIAT plateau karavia</option>
                                    </select>
                                </div><br><br>
                                <div class="form-group col-md-12">
                                    <input class="form-control" name="observation" value="<?= ($police['observation']) ?>"
                                        cols="" rows="3" placeholder="votre observation" />
                                </div><br><br>
