                                    ...
                                    <?php foreach (($policier?:[]) as $p): ?>
                                        <tr>
                                            ...
                                            <?php if ($p['armes']!='' and $p['nb_munition'] !=0): ?>
                                                <!--- lorsque l'arme où munition sont attribuer qu'on affiche une Icon ronde de tres bien  avec comme couleur verte en bootstrap sinon on affiche une icon en point d'interrogation avec comme couleur rouge-->
                                            ...
                                            <td>
                                                ...
                                                <a href="<?= ($BASE . '/desattribuer/' . $p['id_policier']) ?>"><input name="" id="" class="btn btn-danger" type="button" value="Désaffecter"></a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                    </tbody>
