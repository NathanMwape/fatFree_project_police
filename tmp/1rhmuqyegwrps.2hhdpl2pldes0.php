            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4"><a href="<?= ($BASE . '/attribution') ?>"><i class="fa fa-arrow-left"  aria-hidden="true" style="color: black;"></i></a> ATTRIBUTION</h1>
                        <hr>
                                ...
                                <Strong class="form-group"><?= ($police['prenom']) ?></Strong>
                                    ...
                                    <div class="modal-body">
                                        <form action="/attribution/<?= ($police['id_policier']) ?>/<?= ($arm['id_arme']) ?>" method="POST">
                                            ...
                                            <div class="row">
                                                <p>Attribution d'arme et minution</p>
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="number" id="nombre_munition" name="nombre_munition" value="nombre_munition" class="form-control">
                                                </div><br>
                                                <div class="form-group col-md-6">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="number" name="nombre_attrib" value="" class="form-control" placeholder="Nombre de minution"><br>
                                                </div><br><br>
                                            </div>
